...
f32_4 TNCColor::ToFloat()
{
	return { r / 255.f, g / 255.f, b / 255.f, a / 255.f };
}

s32_3 TNCColor::ToHSV()
{
	s32_3 hsv = { 0,0,0 };
...
u32 TNCColor::ToHexAlpha()
{
	return (r << 24) | (g << 16) | b << 8 | a;
}

Maths::Vec3 TNCColor::ToVector3() const
{
...
TNCColor TNCColor::CreateRGBA(s32 _r, s32 _g, s32 _b, s32 _a)
{
	Clamp(_r, 0, 255);
	Clamp(_g, 0, 255);
	Clamp(_b, 0, 255);
...
TNCColor TNCColor::CreateRGBAFloat(f32 _r, f32 _g, f32 _b, f32 _a)
{
	Clamp(_r, 0.f, 1.f);
	Clamp(_g, 0.f, 1.f);
	Clamp(_b, 0.f, 1.f);
...
TNCColor TNCColor::CreateHSV(s32 _h, s32 _s, s32 _v)
{
	u8 r = 0;
	u8 g = 0;
	u8 b = 0;
...
TNCColor TNCColor::CreateHexRGB(s32 _hex)
{
	s32 r = (_hex >> 16) & 0xFF;
	s32 g = (_hex >> 8) & 0xFF;
	s32 b = _hex & 0xFF;
...
TNCColor TNCColor::operator*(float _mult) const
{
	return CreateRGBA((int)(r * _mult), (int)(g * _mult), (int)(b * _mult), a);
}

//std::ostream& operator<<(std::ostream& os, const TNCColor& color)
//{
//	os << "Color(RGBA): ["
