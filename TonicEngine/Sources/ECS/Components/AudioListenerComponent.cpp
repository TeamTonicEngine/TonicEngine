...
u32 ECS::Components::AudioListenerComponent::s_ids = 0;
//Remember to Init after
ECS::Components::AudioListenerComponent::AudioListenerComponent() = default;
ECS::Components::AudioListenerComponent::~AudioListenerComponent() = default;
//Remember to Init after
ECS::Components::AudioListenerComponent::AudioListenerComponent(const AudioListenerComponent&) = default;
